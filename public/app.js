...
(0, _page2.default)('/', function (ctx, next) {
    ...
    main.empty().append(_template2.default);
});

},{"./template":16,"page":10}],16:[function(require,module,exports){
'use strict';
...
var box = (0, _yoYo2.default)(_templateObject);
module.exports = (0, _layout2.default)(box);
...
require('./homepage'); /*var numeros = [400,200,1,-23];
...
},{"./homepage":15,"./signin":20,"./signup":22,"page":10}],18:[function(require,module,exports){
'use strict';
...
module.exports = (0, _landing2.default)(box);
...
},{"./template":23,"page":10}],23:[function(require,module,exports){
'use strict';
